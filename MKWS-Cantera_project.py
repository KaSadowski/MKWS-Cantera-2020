...
for i in range(liczT):
    ...
    for j in range(liczP):
        ...
        while tnow < tfinal:
            ...
            if przestrzen_obliczeniowa.Y[gas.species_index('OH')] == OH_ante and przestrzen_obliczeniowa.Y[
                gas.species_index('OH')] < ymax:
                break
...
print(Tplot)
print(Pplot)
surf = ax.plot_surface(Pplot, Tplot, Z, rstride=1, cstride=1, cmap=cm.inferno,
